...
DB_SETTINGS = {
    "user": load_environment()["POSTGRES_USER"],
    "password": load_environment()["POSTGRES_PASSWORD"],
    "database": load_environment()["POSTGRES_DB"],
    "host": load_environment()["POSTGRES_SERVER"],
    "port": load_environment()["POSTGRES_PORT"],
}
